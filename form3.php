            ...
            <div class="card-body">
                <form action="Form4.php">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <input type="radio" name="Failure" required id="radio1">
                            </div>
                        </div>
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <input type="radio" name="Failure" required id="radio2">
                            </div>
                        </div>
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <input type="radio" name="Failure" required id="radio3">
                            </div>
                        </div>
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <input type="radio" name="Failure" required id="radio4">
                            </div>
                        </div>
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <input type="radio" name="Failure" required id="radio5">
                            </div>
                        </div>
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <input type="radio" name="Failure" required id="radio6">
                            </div>
                        </div>
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <input type="radio" name="Failure" required id="radio7">
                            </div>
                        </div>
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <input type="radio" name="Failure" required id="radio8">
                            </div>
                        </div>
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-6">
                            <button class="btn btn-outline-primary btn-lg form-control"
                                onclick="document.location.href='Form4.php'">Next</button>
                        </div>
                    </div>
                </form>
            </div>
